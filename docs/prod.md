...
- `ingress.host`: `quiz.opencompany.example`
- `ingress.komodoHost`: `komodo.quiz.opencompany.example`
...
- Open the application URLs:
  - https://quiz.opencompany.example
  - https://komodo.quiz.opencompany.example
